...
class Ball(pygame.sprite.Sprite):
    def __init__(self, radius, x, y):
        ...
        self.rect = pygame.Rect(x, y, 1.7 * radius, 1.7 * radius)
    ...
    def update(self):
        ...
        if pygame.sprite.spritecollideany(self, horizontal_borders) and pygame.sprite.spritecollideany(self, vertical_borders):
            ...
            self.vx = -self.vx
        elif pygame.sprite.spritecollideany(self, main) and self.x <= 600:
            self.effect.play()
            self.vy = -self.vy
        elif pygame.sprite.spritecollideany(self, breakable_boxes):
            self.vy = -self.vy
        elif pygame.sprite.spritecollideany(self, unbreakable_boxes):
            self.vy = -self.vy
